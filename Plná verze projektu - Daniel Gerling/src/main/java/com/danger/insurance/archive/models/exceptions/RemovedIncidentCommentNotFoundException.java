 ...
 */
public class RemovedIncidentCommentNotFoundException extends RuntimeException {
	private static final long serialVersionUID = 3L;
	
	/**
     * Constructs a new {@code PartyNotFoundException} with a default message.
     */
	public RemovedIncidentCommentNotFoundException() {
        super("Removed incident comment not found.");
    }
}
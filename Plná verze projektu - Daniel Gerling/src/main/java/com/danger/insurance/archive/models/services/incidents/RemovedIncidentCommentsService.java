...
public interface RemovedIncidentCommentsService {
     ...
     */
	long create(RemovedIncidentCommentsDTO entry);
     ...
     */
	List<RemovedIncidentCommentsDTO> getAll();
     ...
     */
	RemovedIncidentCommentsDTO getById(long removedIncidentCommentId);
     ...
     */
	void edit(RemovedIncidentCommentsDTO removedIncidentCommentsDTO);
     ...
     */
	void delete(long removedIncidentCommentId);
}
package com.danger.insurance.insurances.contracts.models.exceptions;
 ...
 */
public class PartyContractNotFoundException extends RuntimeException {
	private static final long serialVersionUID = 1L;
	
	/**
     * Constructs a new {@code PartyNotFoundException} with a default message.
     */
	public PartyContractNotFoundException() {
        super("PartyContract not found.");
    }
}